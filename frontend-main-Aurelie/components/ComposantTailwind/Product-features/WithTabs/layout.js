    ...
    features: [
      {
        ...
        imageSrc: "/../public/assets/images/product-feature-06-detail-01.jpg",
        imageAlt:
    ...
    features: [
      {
        ...
        imageSrc: "/../public/assets/images/product-feature-06-detail-02.jpg",
        imageAlt:
      ...
      >
        <div className="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
          <div className="max-w-3xl">
            <h2
              id="features-heading"
              className={` text-gray-900 sm:text-4xl ${props.style.font_title.font_size} ${props.style.font_title.font_family} ${props.style.font_title.font_weight} `}
            >
              Technical Specifications
            </h2>
            <p
              className={`mt-4 text-gray-500 ${props.style.font_text.font_family} ${props.style.font_text.font_size} ${props.style.font_text.font_weight}`}
            >
                  ...
                  {tab.features.map((feature) => (
                    ...
                    >
                      <div className="mt-6 lg:col-span-5 lg:mt-0">
                        <h3
                          className={` text-gray-900 ${props.style.font_text.font_size} ${props.style.font_text.font_family} ${props.style.font_text.font_weight}`}
                        >
                          {feature.name}
                        </h3>
                        <p
                          className={`mt-2  text-gray-500 ${props.style.font_paragraphe.font_family} ${props.style.font_paragraphe.font_weight} ${props.style.font_paragraphe.font_size}`}
                        >
                          {feature.description}
                        </p>
                      </div>
                      <div className="lg:col-span-7">
                        <div
                          className={`aspect-h-1 w-full aspect-w-2 overflow-hidden bg-gray-100 sm:aspect-h-2 sm:aspect-w-5 ${props.style.image.border_color} ${props.style.image.border_style} ${props.style.image.border_width} ${props.style.image.box_shadow}  ${props.style.image.border_radius}`}
                        >
                          <Image
